...
def BuildStockfish(depth: int=15, elo: int=1200) -> Stockfish:
    """
...
def InitializeAI(engine: Stockfish, area: Board) -> None:
...
def PollStockfishMoves(engine: Stockfish, n: int) -> list:
    """
