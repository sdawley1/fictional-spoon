...
class Player:
    def __init__(self, color: bool, wins: float, losses: float, engine: Stockfish=None) -> None:
    ...
    def add_draw(self) -> None:
        """ Add a draw to the player's record """
        self.wins += 0.5
        self.losses += 0.5
        return

    # Here begin the AI specific-functions for initialization
    def InitializeStockfish(self, elo: int=1200) -> None:
